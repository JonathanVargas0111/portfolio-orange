...
const Contact = () => {
    return (
        <div className='bg-gradient-to-t from-black  to-black py-8 px-auto flex flex-col justify-center'>
            ...
            <div className='lg:max-w-5xl mx-auto flex flex-col lg:flex-row text-white/70 p-8
                    rounded-lg space-y-8 lg:space-y-0 lg:space-x-8 items-center justify-center 
                    ' id='contact'>
