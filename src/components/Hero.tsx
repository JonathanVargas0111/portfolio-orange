...
const Hero = () => {
    return (
        <div className="py-24 relative overflow-clip bg-slate-950">
            <div className='absolute rounded-[60%] w-[3000px] h-[1200px] top-[520px] left-[50%] -translate-x-1/2 
            ...
            <div className='relative'>
                ...
                <motion.div
                    className='hidden xl:flex absolute left-[250px] top-[170px]' 
                    drag
                >
                    <Image
                        src={cursor}
                ...
                <motion.div
                    className='hidden xl:flex absolute right-[220px] top-[20px]' 
                    drag
                >
                    <Image
                        src={lightning}
